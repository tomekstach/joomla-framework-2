...
class LogoutMethodTest extends TestCase
{
  ...
  /**
   * Simple test for logout method.
   */
  public function testShouldLogoutUserIfUserIsLoggedIn()
  {
    // Given
    ...
    // When
    $result = $this->AuthenticationModelUnderTest->logout();
  ...
  public function testShouldReturnExceptionIfUserIsNotLoggedIn()
  {
    ...
    $this->expectExceptionMessage('User already logged out!');

...
class GetTokenMethodTest extends TestCase
{
  /** @var container */
  private $container;
  ...
  /**
   * Simple test for getToken method.
   */
  public function testShouldLogoutUserIfUserIsLoggedWithoutTokenAndUserHasAccess()
  {
    // Given
    ...
    // When
    $result = $this->AuthenticationModelUnderTest->getToken();

    // Then
    $this->assertArrayHasKey('jws', $result);
  }
   ...
   * Simple test for getToken method.
   */
  public function testShouldReturnExceptionIfUserDoesNotHaveAccess()
  {
    // Expected
    $this->expectException(APIException::class);
    $this->expectExceptionMessage('You do not have access to this method!');
   ...
   * Simple test for getToken method.
   */
  public function testShouldReturnExceptionIfUserIsLoggedByToken()
  {
    // Expected
    $this->expectException(APIException::class);
    $this->expectExceptionMessage('You do not have access to this method!');
    ...
    $this->session->set('userid', $userId);
    $this->session->set('level', 4);
    $this->session->set('sessionhash', 'h8rnhp9ff60elmbplvr12c4v84');
